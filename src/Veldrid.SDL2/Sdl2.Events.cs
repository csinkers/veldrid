...
public static unsafe partial class Sdl2Native
{
    ...
    static SDL_AddEventWatch_t s_sdl_addEventWatch = LoadFunction<SDL_AddEventWatch_t>(
        "SDL_AddEventWatch"
    );
    ...
    static SDL_SetEventFilter_t s_sdl_setEventFilter = LoadFunction<SDL_SetEventFilter_t>(
        "SDL_SetEventFilter"
    );
    ...
    static SDL_FilterEvents_t s_sdl_filterEvents = LoadFunction<SDL_FilterEvents_t>(
        "SDL_FilterEvents"
    );
