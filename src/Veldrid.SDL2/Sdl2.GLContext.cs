...
public static unsafe partial class Sdl2Native
{
    ...
    public static int SDL_GL_SetAttribute(SDL_GLAttribute attr, int value) =>
        s_gl_setAttribute(attr, value);
    ...
    public static int SDL_GL_GetAttribute(SDL_GLAttribute attr, int* value) =>
        s_gl_getAttribute(attr, value);
    ...
    public static int SDL_GL_MakeCurrent(SDL_Window Sdl2Window, IntPtr context) =>
        s_gl_makeCurrent(Sdl2Window, context);
