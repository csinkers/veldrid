...
internal static class MTLUtil
{
    internal const string ObsoleteUtf16Message =
        "Prefer the UTF8 overload to skip conversion costs.";
    ...
    public static T AllocInit<T>(string typeName)
        where T : unmanaged
    {
    ...
    public static T AllocInit<T>(ReadOnlySpan<byte> utf8TypeName)
        where T : unmanaged
    {
