...
internal readonly struct EAGLContext
{
    ...
    static readonly Selector sel_initWithAPI = "initWithAPI:"u8;
    static readonly Selector sel_setCurrentContext = "setCurrentContext:"u8;
    static readonly Selector sel_renderBufferStorage = "renderbufferStorage:fromDrawable:"u8;
    static readonly Selector sel_presentRenderBuffer = "presentRenderbuffer:"u8;
    static readonly Selector sel_currentContext = "currentContext"u8;
}
