...
internal sealed unsafe class OpenGLPipeline : Pipeline, IOpenGLDeferredResource
{
    ...
    int GetAttribLocation(ReadOnlySpan<char> elementName, ref Span<byte> byteBuffer)
    {
    ...
    void BindAttribLocation(uint slot, ReadOnlySpan<char> elementName, ref Span<byte> byteBuffer)
    {
        Util.GetNullTerminatedUtf8(elementName, ref byteBuffer);
    ...
    void ProcessResourceSetLayouts(ResourceLayout[] layouts, Span<byte> byteBuffer)
    {
    ...
    uint GetUniformBlockIndex(ReadOnlySpan<char> resourceName, ref Span<byte> byteBuffer)
    {
    ...
    int GetUniformLocation(ReadOnlySpan<char> resourceName, ref Span<byte> byteBuffer)
    {
        Util.GetNullTerminatedUtf8(resourceName, ref byteBuffer);
    ...
    void ReportInvalidUniformBlockName(ReadOnlySpan<char> uniformName, Span<byte> byteBuffer)
    {
        VerifyLastError();
    ...
    [Conditional("GL_VALIDATE_SHADER_RESOURCE_NAMES")]
    void ReportInvalidUniformName(ReadOnlySpan<char> uniformName, Span<byte> byteBuffer)
    {
        VerifyLastError();
    ...
    void ProcessLinkedProgram(Span<byte> byteBuffer)
    {
        int linkStatus = 0;
