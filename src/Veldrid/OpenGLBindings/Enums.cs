...
internal enum GLFramebufferAttachment
{
    FrontLeft = 1024,
    FrontRight = 1025,
    BackLeft = 1026,
...
internal enum SamplerParameterName
{
...
internal enum BufferRangeTarget
{
    UniformBuffer = 35345,
    TransformFeedbackBuffer = 35982,
    ShaderStorageBuffer = 37074,
...
internal enum StringNameIndexed
{
    Extensions = 7939,
}

internal enum ObjectLabelIdentifier
{
    Texture = 5890,
    VertexArray = 32884,
    Buffer = 33504,
...
internal enum MemoryBarrierFlags
{
...
[Flags]
internal enum BufferStorageMask
{
...
internal enum RenderbufferPname
{
...
internal enum ClipControlDepthRange
{
