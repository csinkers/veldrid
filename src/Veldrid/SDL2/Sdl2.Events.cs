...
public static unsafe partial class Sdl2Native
{
    ...
    static readonly SDL_AddEventWatch_t s_sdl_addEventWatch = LoadFunction<SDL_AddEventWatch_t>(
        "SDL_AddEventWatch"
    );
    ...
    static readonly SDL_SetEventFilter_t s_sdl_setEventFilter = LoadFunction<SDL_SetEventFilter_t>(
        "SDL_SetEventFilter"
    );
    ...
    static readonly SDL_FilterEvents_t s_sdl_filterEvents = LoadFunction<SDL_FilterEvents_t>(
        "SDL_FilterEvents"
    );

    /// <summary>
    /// Filter events in the event queue.
    /// </summary>
...
/// <summary>
/// Flags enum for mouse button states
/// </summary>
[Flags]
