...
) : IDisposable
{
    ...
    ChunkAllocatorSet GetAllocator(uint memoryTypeIndex, bool persistentMapped)
    {
    ...
    sealed class ChunkAllocator : IDisposable
    {
        ...
        static int FindPrecedingBlockIndex(ReadOnlySpan<VkMemoryBlock> list, ulong targetOffset)
        {
            int low = 0;
        ...
        void CheckAllocatedBlock(uint offset, ulong size)
        {
        ...
        static void ThrowTrackException(string message)
        {
