...
internal static unsafe class VkSurfaceUtil
{
    ...
    static VkSurfaceKHR CreateAndroidSurface(IntPtr khr, VkInstance instance, IntPtr aNativeWindow)
    {
    ...
    static void GetMetalLayerFromUIView(UIView uiView, out CAMetalLayer metalLayer)
    {
